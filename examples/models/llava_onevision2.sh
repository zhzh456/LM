...
accelerate launch --num_processes=1 --main_process_port=12346 -m lmms_eval \
    --model llava_onevision2 \
    --model_args=pretrained=lmms-lab-encoder/LLaVA-OneVision-2-8B-Instruct,attn_implementation=sdpa,max_pixels=786432,interleave_visuals=False \
    --tasks "tomato" \
    --batch_size 1 \
    --limit 8