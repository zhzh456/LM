...
accelerate launch --num_processes=1 --main_process_port=12346 -m lmms_eval \
    --model qwen3_vl \
    --model_args=pretrained=/home/zhanghao360/model/Qwen3-VL-4B-Instruct,max_pixels=12845056,max_num_frames=44,interleave_visuals=False,attn_implementation=flash_attention_2,log_input_length=True,print_generation=True \
    --tasks "tomato" \
    --batch_size 1 \
    --limit 128
